...
extern bool flagMonitorMode;

extern bool	bMonitFile;
extern char MonitFile[256];

extern bool	bEndBatch;
extern char	EndBatchFile[256];

extern SORA_RADIO_RX_STREAM	RxStream;	// RxStream
extern PVOID				RxBuffer;	// Mapped Rx Buffer
extern ULONG				RxBufferSize;
extern bool                 is_whitespace;
extern ULONG				centralfreq;
extern ULONG				rxgain;
extern ULONG				rxpa;
extern ULONG				freqoffset;
...
extern bool bUMX;
inline bool umx_enabled () { return bUMX; }
extern bool					bGetCmdline;
extern char					gcmdline [512];
