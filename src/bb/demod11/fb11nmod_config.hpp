...
{
    void init ( ushort mcs_index, uchar * pBuffer, ushort frame_len, COMPLEX16* sbuf[], uint sbuf_size )
    {
        ...
        // TxVector
        CF_11nTxVector::frame_length() = frame_len;
        CF_11nTxVector::mcs_index() = mcs_index; 	   // 1Mbps
        CF_11nTxVector::crc32 () = CalcCRC32(pBuffer, frame_len ); // no CRC32?
...
static FINL ISource* CreateModGraph11n () {
    ...
    CREATE_BRICK_FILTER ( map_qam16_s0,	    TMap11aQAM16<9594>::Filter,    BB11nModCtx, addpilot_s0 );
    CREATE_BRICK_FILTER ( map_qam16_s1,	    TMap11aQAM16<9594>::Filter,    BB11nModCtx, addpilot_s1 );
    CREATE_BRICK_FILTER ( map_qam64_s0,	    TMap11aQAM64<4681>::Filter,    BB11nModCtx, addpilot_s0 );
    CREATE_BRICK_FILTER ( map_qam64_s1,	    TMap11aQAM64<4681>::Filter,    BB11nModCtx, addpilot_s1 );
    ...
    CREATE_BRICK_FILTER ( inter_qam16_s0,   T11nInterleaveQAM16_S1::Filter,    BB11nModCtx, map_qam16_s0 );
    CREATE_BRICK_FILTER ( inter_qam16_s1,   T11nInterleaveQAM16_S2::Filter,    BB11nModCtx, map_qam16_s1 );
    CREATE_BRICK_FILTER ( inter_qam64_s0,	T11nInterleaveQAM64_S1::Filter,    BB11nModCtx, map_qam64_s0 );
    CREATE_BRICK_FILTER ( inter_qam64_s1,	T11nInterleaveQAM64_S2::Filter,    BB11nModCtx, map_qam64_s1 );
    ...
    CREATE_BRICK_DEMUX2 ( sp_qam16,	        TStreamParserQAM16_12,    BB11nModCtx, inter_qam16_s0,inter_qam16_s1 );
    CREATE_BRICK_DEMUX2 ( sp_qam64,	        TStreamParserQAM64_12,    BB11nModCtx, inter_qam64_s0,inter_qam64_s1 );
    ...
    CREATE_BRICK_FILTER ( enc11,	        TConvEncode_12,     BB11nModCtx, sp_qam16 );
    CREATE_BRICK_FILTER ( enc12,	        TConvEncode_34,     BB11nModCtx, sp_qam16 );
    CREATE_BRICK_FILTER ( enc13,            TConvEncode_23,     BB11nModCtx, sp_qam64 );
    CREATE_BRICK_FILTER ( enc14,	        TConvEncode_34,     BB11nModCtx, sp_qam64 );

    CREATE_BRICK_DEMUX8 ( mrsel,	        TBB11nMRSelect,     BB11nModCtx,
        enc8, enc9, enc10, enc11, enc12, enc13, enc14, drop );
